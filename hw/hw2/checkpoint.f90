! I implement a checkpoint subroutine for a debugging mode, with parameters for verbosity and an explaination message
! I implimented it on the matrix multipliation code developed for the first homework.
